...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Dismiss'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_No'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Dismiss'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Test'))

WebUI.click(findTestObject('Object Repository/Page_Element  Test/div'))

WebUI.setText(findTestObject('Object Repository/Page_Element  Test/div_hello_mx_BasicMessageComposer_input mx__cb046d'), 
    '<div style=""><br></div>')
