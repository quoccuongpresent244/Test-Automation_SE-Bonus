...
WebUI.rightClick(findTestObject('Object Repository/Page_Element  asdasdasdsds/div_beta'))

WebUI.click(findTestObject('Object Repository/Page_Element  asdasdasdsds/span_Low Priority'))
