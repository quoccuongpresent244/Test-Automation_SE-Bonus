...
WebUI.click(findTestObject('Object Repository/Page_Element/span_A'))

WebUI.rightClick(findTestObject('Object Repository/Page_Element  asdasdasdsds/div_Rooms_mx_AccessibleButton mx_RoomSublis_e10a17'))

WebUI.click(findTestObject('Object Repository/Page_Element  asdasdasdsds/div_Show rooms with unread messages first_m_86b35d'))
