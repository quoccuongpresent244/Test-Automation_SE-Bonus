...
WebUI.click(findTestObject('Object Repository/Page_Element 2/div_Verify with another device'))

WebUI.click(findTestObject('Object Repository/Page_Element 2/div_Verify other device_mx_AccessibleButton_7edffc'))

WebUI.rightClick(findTestObject('Object Repository/Page_Element 2/div_Genshin Impact  5.0K'))

WebUI.click(findTestObject('Object Repository/Page_Element 2/span_Leave'))

WebUI.click(findTestObject('Object Repository/Page_Element 2/button_Leave'))
