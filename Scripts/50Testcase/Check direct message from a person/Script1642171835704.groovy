...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element/div_unitoflazy'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element 1/div_Invites1UunitoflazyFavoritesPeopleRooms_d6fcdb'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_unitoflazy'))

CustomKeywords.'quocpackage.wait.DelayTime'(3000)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element 1  unitoflazy/div_Do you want to chat with unitoflazyUuni_647395'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Element 1  unitoflazy/div_Start chatting'))

CustomKeywords.'quocpackage.wait.DelayTime'(10000)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  unitoflazy/div_UunitoflazyThis is the beginning of you_84cfbc'), 
    0)
