...
WebUI.click(findTestObject('Object Repository/Page_Element/img_People_mx_BaseAvatar_image'))

CustomKeywords.'quocpackage.wait.DelayTime'(5000)

WebUI.mouseOver(findTestObject('Object Repository/Page_Element  Chi Nguyn/div_hello'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.click(findTestObject('Object Repository/Page_Element  Chi Nguyn/div_Hello_mx_AccessibleButton mx_MessageAct_a206ac'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.click(findTestObject('Object Repository/Page_Element  Chi Nguyn/span_Remove'))

WebUI.click(findTestObject('Object Repository/Page_Element  Chi Nguyn/button_Remove'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Chi Nguyn/span_Message deleted'), 0)
