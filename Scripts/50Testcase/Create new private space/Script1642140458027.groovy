...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Review_mx_SpaceButton_icon_1'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.click(findTestObject('Object Repository/Page_Element/div_PrivateInvite only, best for yourself or teams'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Upload_spaceName'), 'my private space for testing')

WebUI.click(findTestObject('Object Repository/Page_Element/div_Create'))

CustomKeywords.'quocpackage.wait.DelayTime'(3000)

WebUI.click(findTestObject('Object Repository/Page_Element  Empty room/div_A private space to organize your rooms'))

CustomKeywords.'quocpackage.wait.DelayTime'(3000)

WebUI.click(findTestObject('Object Repository/Page_Element  Empty room/div_Skip for now'))

CustomKeywords.'quocpackage.wait.DelayTime'(3000)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Empty room/div_Welcome to my private space for testing'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Empty room/div_Private space1 memberInvite'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Empty room/div_Rooms and spacesAddRemoveMark as not suggested'), 
    0)
