...
WebUI.click(findTestObject('Object Repository/Page_Element  unitoflazy/div'))

WebUI.setText(findTestObject('Object Repository/Page_Element  unitoflazy/div_gr'), ':gr')

CustomKeywords.'quocpackage.wait.DelayTime'(500)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  unitoflazy/div_grinning'), 0)

WebUI.click(findTestObject('Object Repository/Page_Element  unitoflazy/div_grinning'))

WebUI.click(findTestObject('Object Repository/Page_Element  unitoflazy/div__mx_AccessibleButton mx_MessageComposer_d2d5d0'))
