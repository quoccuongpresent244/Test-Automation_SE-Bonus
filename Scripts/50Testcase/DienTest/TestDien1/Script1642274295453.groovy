...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Or_mx_RegistrationForm_username'), 'dientrankkk')
...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Confirm password_mx_Field_1'), 'klaaa@gmail.com')
