...
WebUI.setText(findTestObject('Object Repository/Page_ng nhp - Ti khon Google/input_matrix.org_identifier (1)'), 'thadien19@apcs.vn')

WebUI.click(findTestObject('Object Repository/Page_ng nhp - Ti khon Google/span_Tip theo (1)'))
