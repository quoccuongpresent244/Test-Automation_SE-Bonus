...
WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Explore Public Rooms'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Join'))

WebUI.click(findTestObject('Object Repository/Page_Element 2  Genshin Impact/div'))

WebUI.setText(findTestObject('Object Repository/Page_Element 2  Genshin Impact/div_hello'), '<div style="">hello</div>')

WebUI.click(findTestObject('Object Repository/Page_Element 2  Genshin Impact/div_hello_mx_AccessibleButton mx_MessageCom_fe84b1'))
