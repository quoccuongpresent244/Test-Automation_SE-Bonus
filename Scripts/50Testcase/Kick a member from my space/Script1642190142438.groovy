...
WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/img_Private space_mx_BaseAvatar_image'))

CustomKeywords.'quocpackage.wait.DelayTime'(500)

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/div_CChi Nguyn'))

CustomKeywords.'quocpackage.wait.DelayTime'(500)

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/div_Kick'))

CustomKeywords.'quocpackage.wait.DelayTime'(500)

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/button_Kick'))
