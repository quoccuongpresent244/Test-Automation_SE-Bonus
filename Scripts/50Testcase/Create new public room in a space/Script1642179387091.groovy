...
WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/div_Add'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/span_Create new room'))

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.setText(findTestObject('Object Repository/Page_Element  my private space for testing/input_Create a room_mx_Field_5'), 
    'my public room for testing4')

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/button_Create Room'))

CustomKeywords.'quocpackage.wait.DelayTime'(8000)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Empty room/div_Uunitoflazy created and configured the room'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element  Empty room/div_unitoflazy created and configured the r_8d8e12'), 
    0)
