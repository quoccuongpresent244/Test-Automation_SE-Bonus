...
WebUI.setText(findTestObject('Object Repository/Page_Element  my private space for testing/input_Create a room_mx_Field_5'), 
    'my private room for testing')

CustomKeywords.'quocpackage.wait.DelayTime'(1000)

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/div_Visible to space members'))

WebUI.click(findTestObject('Object Repository/Page_Element  my private space for testing/div_Private room (invite only)'))
